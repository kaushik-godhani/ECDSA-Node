...
import { toBuffer, toHex, utf8ToBytes } from "ethereum-cryptography/utils";
...
function Transfer({ address, setBalance }) {
  ...
  async function transfer(evt) {
    ...
    const signature = secp.secp256k1.sign(keccak256(utf8ToBytes("me")), privateKeyBuffer);
    ...
    const sender =  secp.secp256k1.publicKeyCreate(privateKeyBuffer, true);
